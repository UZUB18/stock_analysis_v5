/**
 * CoffeeLoader — stretchy coffee cup animation.
 * Adapted from the "stretchy-coffee-chrome-ff-only" CodePen demo.
...
export default function CoffeeLoader() {
  return (
    <div className="coffee-loader-container">
      ...
      <p className="coffee-loader-text">Brewing your analysis…</p>
    </div>
  );
}
